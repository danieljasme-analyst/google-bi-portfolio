...
| Course 2 | The Path to Insights: Data Models and Pipelines | ✅ Complete | [Read →](https://danieljasme.hashnode.dev) | SQL pipeline, target table (1,350 rows) |
| Course 3 | Decisions, Decisions: Dashboards and Reports | ✅ Complete | [Read →](https://danieljasme.hashnode.dev) | Tableau dashboard (7 sheets, 4 dashboards), Executive Summary |
...
- SQL data pipeline design (BigQuery UNION ALL)
- Data schema design and ETL pipeline development
- Dashboard design and data visualization (Tableau Public)
- Cross-functional communication and executive reporting
...
**My role:** BI Analyst candidate building an end-to-end dashboard solution for the call center leadership tea# Google Business Intelligence Certificate — Portfolio
